/**
  ...
  ******************************************************************************
  *
  * ISM6HG256X Smart Asset Tracking MLC+FSM configuration, converted to the
  * flat ucf_line_t register/value format used by sensors_iks5a1.c (same
  * loader pattern as lsm6dsv16x_asset_tracking.h on the IKS4A1 build).
  *
  * Source: STMicroelectronics st-mems-machine-learning-core repository,
  *   examples/asset_tracking/ism6hg256x/ism6hg256x_asset_tracking.h
  *   (BSD-3-Clause; all 220 ops are plain register writes — converted 1:1).
  *
  * Same Smart Asset Tracking algorithm and MLC1_SRC (0x70) output classes as
  * the LSM6DSV16X variant:
  *   0x00 = Stationary - Upright     0x04 = Stationary - Not upright
  *   0x08 = In motion                0x0C = Shaken
  * so the existing /IOTCONNECT decoder model (asset_tracking, model id 1)
  * applies unchanged.
  ******************************************************************************
  */
...
/** Configuration array (register, value) for the ISM6HG256X **/
const ucf_line_t ism6hg256x_asset_tracking[] = {
