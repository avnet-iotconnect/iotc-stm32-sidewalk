...
A device also needs an **Amazon Sidewalk gateway** (a compatible Amazon Echo or Ring device) in range — see [Amazon Sidewalk gateway](GETTING_STARTED.md#amazon-sidewalk-gateway) for the compatible models and their one-time setup.
